...
control Eg(inout Headers hdrs,
    ...
    // 2. inKey and evictedKey are of type struct Key_R1. evictedValue is of type struct Value_R1.
    ...
    register<bit<32>>(32w1024) regK_R1_f0;
    register<bit<32>>(32w1024) regK_R1_f1;
    register<bit<32>>(32w1024) regK_R1_f2;
    register<bit<32>>(32w1024) regK_R1_f3;
    register<bit<32>>(32w1024) regK_R1_f4;
    register<bit<32>>(32w1024) regK_R1_f5;


    // Template hole: register for each field in value
    register<bit<32>>(32w1024) regV_R1_f0;
    register<bit<32>>(32w1024) regV_R1_f1;


    // Template hole: action signature for groupby
    action R1(inout Key_R1 evictedKey, inout Value_R1 evictedValue) {
        ...
        inKey.f5 = (bit<32>)hdrs.ip.identification;
        ...
        regK_R1_f0.read(existingKey_f0, hash_table_index);
        regK_R1_f1.read(existingKey_f1, hash_table_index);
        regK_R1_f2.read(existingKey_f2, hash_table_index);
        regK_R1_f3.read(existingKey_f3, hash_table_index);
        regK_R1_f4.read(existingKey_f4, hash_table_index);
        regK_R1_f5.read(existingKey_f5, hash_table_index);

        regV_R1_f0.read(existingValue_f0, hash_table_index);
        regV_R1_f1.read(existingValue_f1, hash_table_index);
        ...
        bit<32> _val_e2e_latency = ok ? existingValue_f0  : 0;
        bit<32> _val_last_switch = ok ? existingValue_f1  : 0;
        ...
        // Function body
        bool _pred_1;
        bit<32> _e2e_latency_a;
        bit<32> _e2e_latency_b;
        _tmp_R1_valid = false;
        _e2e_latency_a = 32w1;
        _e2e_latency_b = 32w0;
        _pred_1 = true;
        _e2e_latency_a = (_e2e_latency_a)*(32w1);
        _e2e_latency_b = ((meta.common_meta.egress_timestamp)-((bit<32>)meta.queueing_metadata.enq_timestamp))+((32w1)*(_e2e_latency_b));
        _val_last_switch = meta.common_meta.switchId;
        _tmp_R1_valid = (_pred_1) || (_tmp_R1_valid);
        meta.query_meta.e2e_latency = _pred_1 ? (_val_e2e_latency) : (meta.query_meta.e2e_latency);
        meta.query_meta.last_switch = _pred_1 ? (_val_last_switch) : (meta.query_meta.last_switch);
        _val_e2e_latency = ((_e2e_latency_a)*(_val_e2e_latency))+(_e2e_latency_b);
        // Postamble
        ...
        regK_R1_f0.write(hash_table_index, inKey.f0);
        regK_R1_f1.write(hash_table_index, inKey.f1);
        regK_R1_f2.write(hash_table_index, inKey.f2);
        regK_R1_f3.write(hash_table_index, inKey.f3);
        regK_R1_f4.write(hash_table_index, inKey.f4);
        regK_R1_f5.write(hash_table_index, inKey.f5);

        regV_R1_f0.write(hash_table_index, _val_e2e_latency);
        regV_R1_f1.write(hash_table_index, _val_last_switch);
    ...
    // Function body
    _tmp_R3_valid = (_tmp_R1_valid) && (((meta.query_meta.e2e_latency) > (32w1000)) && ((meta.query_meta.last_switch) == (32w20)));
    // Postamble
    ...
    register<bit<32>>(32w1024) regK_R4_f2;
    register<bit<32>>(32w1024) regK_R4_f3;
    register<bit<32>>(32w1024) regK_R4_f4;
    ...
    action R4(inout Key_R4 evictedKey, inout Value_R4 evictedValue) {
        ...
        regK_R4_f2.read(existingKey_f2, hash_table_index);
        regK_R4_f3.read(existingKey_f3, hash_table_index);
        regK_R4_f4.read(existingKey_f4, hash_table_index);
        ...
        regK_R4_f2.write(hash_table_index, inKey.f2);
        regK_R4_f3.write(hash_table_index, inKey.f3);
        regK_R4_f4.write(hash_table_index, inKey.f4);
    ...
    apply {
        ...
        Key_R1  evictedKey_R1;
        Value_R1 evictedValue_R1;
        R1(evictedKey_R1,evictedValue_R1);
