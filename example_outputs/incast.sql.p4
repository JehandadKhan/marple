...
control Eg(inout Headers hdrs,
    ...
    action R2(inout Key_R2 evictedKey, inout Value_R2 evictedValue) {
        ...
        inKey.f6 = meta.common_meta.switchId;
        ...
        regV_R2_f0.write(hash_table_index, _val_count);
    ...
    action R3(inout Key_R3 evictedKey, inout Value_R3 evictedValue) {
        ...
        // Template hole: Get value if there is no eviction, pass this on to update code
        bit<32> _val_f_count = ok ? existingValue_f0  : 0;
        ...
        bool _pred_4;
        _tmp_R3_valid = false;
        _pred_4 = _tmp_R2_valid;
        _val_f_count = (_val_f_count)+(32w1);
        _tmp_R3_valid = (_pred_4) || (_tmp_R3_valid);
        meta.query_meta.f_count = _pred_4 ? (_val_f_count) : (meta.query_meta.f_count);
        // Postamble
        ...
        regV_R3_f0.write(hash_table_index, _val_f_count);
    ...
    // Function body
    _tmp_result_valid = (_tmp_R4_valid) && ((((bit<32>)meta.queueing_metadata.enq_qdepth) > (32w100)) && ((meta.query_meta.f_count) > (32w50)));
    // Postamble
