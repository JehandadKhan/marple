...
control Eg(inout Headers hdrs,
    ...
    action result(inout Key_result evictedKey, inout Value_result evictedValue) {
        ...
        inKey.f2 = meta.common_meta.switchId;
        ...
        _tmp_result_valid = (_pred_3) || (_tmp_result_valid);
        ...
        regK_result_f1.write(hash_table_index, inKey.f1);
        regK_result_f2.write(hash_table_index, inKey.f2);

        regV_result_f0.write(hash_table_index, _val_count);
