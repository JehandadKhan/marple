...
control Eg(inout Headers hdrs,
    ...
    // 2. inKey and evictedKey are of type struct Key_e2e. evictedValue is of type struct Value_e2e.
    ...
    register<bit<32>>(32w1024) regK_e2e_f0;
    register<bit<32>>(32w1024) regK_e2e_f1;
    register<bit<32>>(32w1024) regK_e2e_f2;
    register<bit<32>>(32w1024) regK_e2e_f3;
    register<bit<32>>(32w1024) regK_e2e_f4;
    register<bit<32>>(32w1024) regK_e2e_f5;


    // Template hole: register for each field in value
    register<bit<32>>(32w1024) regV_e2e_f0;


    // Template hole: action signature for groupby
    action e2e(inout Key_e2e evictedKey, inout Value_e2e evictedValue) {
        ...
        regK_e2e_f0.read(existingKey_f0, hash_table_index);
        regK_e2e_f1.read(existingKey_f1, hash_table_index);
        regK_e2e_f2.read(existingKey_f2, hash_table_index);
        regK_e2e_f3.read(existingKey_f3, hash_table_index);
        regK_e2e_f4.read(existingKey_f4, hash_table_index);
        regK_e2e_f5.read(existingKey_f5, hash_table_index);

        regV_e2e_f0.read(existingValue_f0, hash_table_index);
        ...
        // Postamble
        meta.query_meta._e2e_valid = _tmp_e2e_valid ? (1w1) : (1w0);


        // Template hole: Write the inKey and the updated (or initial) value into the register.
        regK_e2e_f0.write(hash_table_index, inKey.f0);
        regK_e2e_f1.write(hash_table_index, inKey.f1);
        regK_e2e_f2.write(hash_table_index, inKey.f2);
        regK_e2e_f3.write(hash_table_index, inKey.f3);
        regK_e2e_f4.write(hash_table_index, inKey.f4);
        regK_e2e_f5.write(hash_table_index, inKey.f5);

        regV_e2e_f0.write(hash_table_index, _val_e2e_latency);
    ...
    apply {
        ...
        Key_e2e  evictedKey_e2e;
        Value_e2e evictedValue_e2e;
        e2e(evictedKey_e2e,evictedValue_e2e);
