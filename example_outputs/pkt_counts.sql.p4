...
control Eg(inout Headers hdrs,
    ...
    action result(inout Key_result evictedKey, inout Value_result evictedValue) {
        ...
        _counter_b = (32w1)+((32w1)*(_counter_b));
        ...
        regK_result_f3.write(hash_table_index, inKey.f3);
        regK_result_f4.write(hash_table_index, inKey.f4);

        regV_result_f0.write(hash_table_index, _val_counter);
