...
control Eg(inout Headers hdrs,
    ...
    // 2. inKey and evictedKey are of type struct Key_nmo_query. evictedValue is of type struct Value_nmo_query.
    ...
    register<bit<32>>(32w1024) regK_nmo_query_f0;
    register<bit<32>>(32w1024) regK_nmo_query_f1;
    register<bit<32>>(32w1024) regK_nmo_query_f2;
    register<bit<32>>(32w1024) regK_nmo_query_f3;
    register<bit<32>>(32w1024) regK_nmo_query_f4;
    register<bit<32>>(32w1024) regK_nmo_query_f5;


    // Template hole: register for each field in value
    register<bit<32>>(32w1024) regV_nmo_query_f0;
    register<bit<32>>(32w1024) regV_nmo_query_f1;


    // Template hole: action signature for groupby
    action nmo_query(inout Key_nmo_query evictedKey, inout Value_nmo_query evictedValue) {
        ...
        inKey.f3 = meta.common_meta.switchId;
        ...
        regK_nmo_query_f0.read(existingKey_f0, hash_table_index);
        regK_nmo_query_f1.read(existingKey_f1, hash_table_index);
        regK_nmo_query_f2.read(existingKey_f2, hash_table_index);
        regK_nmo_query_f3.read(existingKey_f3, hash_table_index);
        regK_nmo_query_f4.read(existingKey_f4, hash_table_index);
        regK_nmo_query_f5.read(existingKey_f5, hash_table_index);

        regV_nmo_query_f0.read(existingValue_f0, hash_table_index);
        regV_nmo_query_f1.read(existingValue_f1, hash_table_index);
        ...
        bit<32> _val_nm_count = ok ? existingValue_f1  : 0;
        ...
        bool _pred_5;
        bool _pred_6;
        _tmp_nmo_query_valid = false;
        _pred_1 = _tmp_tcp_pkts_valid;
        _pred_2 = (_val_maxseq) > (hdrs.tcp.seqNo);
        _pred_3 = (_pred_1) && (_pred_2);
        _val_nm_count = _pred_3 ? ((_val_nm_count)+(32w1)) : (_val_nm_count);
        _pred_4 = (_pred_1) && (! (_pred_2));
        _pred_5 = (_val_maxseq) < (hdrs.tcp.seqNo);
        _pred_6 = (_pred_4) && (_pred_5);
        _val_maxseq = _pred_6 ? (hdrs.tcp.seqNo) : (_val_maxseq);
        // Postamble
        meta.query_meta._nmo_query_valid = _tmp_nmo_query_valid ? (1w1) : (1w0);


        // Template hole: Write the inKey and the updated (or initial) value into the register.
        regK_nmo_query_f0.write(hash_table_index, inKey.f0);
        regK_nmo_query_f1.write(hash_table_index, inKey.f1);
        regK_nmo_query_f2.write(hash_table_index, inKey.f2);
        regK_nmo_query_f3.write(hash_table_index, inKey.f3);
        regK_nmo_query_f4.write(hash_table_index, inKey.f4);
        regK_nmo_query_f5.write(hash_table_index, inKey.f5);

        regV_nmo_query_f0.write(hash_table_index, _val_maxseq);
        regV_nmo_query_f1.write(hash_table_index, _val_nm_count);
    ...
    apply {
        ...
        Key_nmo_query  evictedKey_nmo_query;
        Value_nmo_query evictedValue_nmo_query;
        nmo_query(evictedKey_nmo_query,evictedValue_nmo_query);
