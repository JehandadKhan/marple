...
control Eg(inout Headers hdrs,
    ...
    action R1(inout Key_R1 evictedKey, inout Value_R1 evictedValue) {
        ...
        inKey.f1 = (bit<32>)meta.queueing_metadata.enq_timestamp;
        ...
        bit<32> _val_cnt = ok ? existingValue_f0  : 0;
        ...
        _pred_1 = true;
        _cnt_a = (_cnt_a)*(32w1);
        _cnt_b = (32w1)+((32w1)*(_cnt_b));
        _tmp_R1_valid = (_pred_1) || (_tmp_R1_valid);
        meta.query_meta.cnt = _pred_1 ? (_val_cnt) : (meta.query_meta.cnt);
        _val_cnt = ((_cnt_a)*(_val_cnt))+(_cnt_b);
        // Postamble
        ...
        regV_R1_f0.write(hash_table_index, _val_cnt);
